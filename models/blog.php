<?php
    class Blog {
        ...
        public function getPostById($id) {
            ...
            $type = "i";
            $fields_array = [$id];
            return $this->executeQuery('fetch a post by id', $query, $type, $fields_array);
        }
        ...
        public function insertNewPost($user_id, $post_type, $title, $slug, $short_description, $content, $category, $date) {
            $today = date("Y-m-d");
            ...
            ";
            $type = "isssssssss";
            $fields_array = [$user_id, $post_type, $title, $slug, $short_description, $content, $category, $date, $today, $today];
            $this->executeQuery('inserting a post', $query, $type, $fields_array);
            return $this->db_conn->insert_id;
        }

        public function updatePost($id, $title, $slug, $short_description, $content, $category, $date) {
            $today = date("Y-m-d");
            ...
            ";
            $type = "sssssssi";
            $fields_array = [$title, $slug, $short_description, $content, $category, $date, $today, $id];
        ...
        private function executeQuery($action, $query, $type = null, $fields_array = null) {
            try {
                ...
                throw new Exception("Blog database queries for '$action' failed.");
            }
        }
    }
?>